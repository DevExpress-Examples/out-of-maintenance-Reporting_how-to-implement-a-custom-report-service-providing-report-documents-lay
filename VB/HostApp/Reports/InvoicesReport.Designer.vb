...
Namespace HostApp
	Partial Public Class InvoicesReport
		...
		Private Sub InitializeComponent()
			...
			' xrTable2
			' 
			Me.xrTable2.LocationFloat = New DevExpress.Utils.PointFloat(15F, 0F)
			Me.xrTable2.Name = "xrTable2"
			Me.xrTable2.Rows.AddRange(New DevExpress.XtraReports.UI.XRTableRow() { Me.xrTableRow2})
			Me.xrTable2.SizeF = New System.Drawing.SizeF(625F, 20.83333F)
			' 
			' xrTableRow2
			' 
			...
			' xrTableCell5
			' 
			Me.xrTableCell5.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() { New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Description")})
			...
			' bindingSource1
			' 
			Me.bindingSource1.DataSource = GetType(HostApp.Invoice)
			' 
			' ReportHeader
			' 
			Me.ReportHeader.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() { Me.xrTable1})
			Me.ReportHeader.HeightF = 36.66667F
			Me.ReportHeader.Name = "ReportHeader"
			' 
			' xrTable1
			' 
			Me.xrTable1.AnchorVertical = DevExpress.XtraReports.UI.VerticalAnchorStyles.Bottom
			Me.xrTable1.LocationFloat = New DevExpress.Utils.PointFloat(15F, 17.5F)
			Me.xrTable1.Name = "xrTable1"
			Me.xrTable1.Rows.AddRange(New DevExpress.XtraReports.UI.XRTableRow() { Me.xrTableRow1})
			Me.xrTable1.SizeF = New System.Drawing.SizeF(625F, 19.16667F)
			' 
			' xrTableRow1
			' 
			...
			Me.Version = "12.1"
'			Me.DataSourceDemanded += New System.EventHandler(Of System.EventArgs)(Me.InvoicesReport_DataSourceDemanded);
